...
var lives = 3;
//var live;
var texture_image = 'water.jpg'
var json_file = 'frog7.json'
var frog;
var frogDefault;
var road;
var river;
...
function initScene() {
    ...
    // box.name = "box";
    //scene.add(box);
    var textureBrick = THREE.ImageUtils.loadTexture(texture_image);
    ...
    river = new THREE.Mesh(new THREE.BoxGeometry(45, 8, 1), new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture(texture_image), transparent: true, opacity: 0.6
    ...
    var textureRoad = THREE.ImageUtils.loadTexture(texture_image);
  ...
  //  frog.position.z = 2;
    ...
    log = new THREE.Mesh(new THREE.BoxGeometry(5, 1.5, 3.1), new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture(texture_image)
...
function loadFroger() {
    ...
    loader.load(json_file, function (geometry, mat) {
